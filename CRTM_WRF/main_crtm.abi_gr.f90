...
PROGRAM crtm 
  ...
  ! ----------
   ...
   INTEGER, parameter :: n_ch=10       !number of channles (10 for GOES-R ABI)
   ...
   INTEGER, parameter :: f_dd=18       !final day
  ...
  !'/scratch/02135/yingyue/EnKF_OSSE/201110120000/noDA'
!   CHARACTER(*), PARAMETER ::OUTPUT_DIR=DATA_DIR//'/radiance'
   CHARACTER(*), PARAMETER ::OUTPUT_DIR=&
  '/work/02135/yingyue/DYNAMO/EnKF_OSSE/201110120000/truth'
